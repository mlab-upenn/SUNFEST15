...
% load college hall data.
load college_hall_kw.mat
...
tic
college_hall_tree14 = fitrtree(Xtrain,Ytrain,'PredictorNames',colnames,'ResponseName','Total Power','CategoricalPredictors',catcol,'MinLeafSize',minleaf);
toc
...
tic
b101treeCV = fitrtree(Xtrain,Ytrain,'PredictorNames',colnames,...
