...
tic;
BaggedEnsemble = TreeBagger(5,Xtrain,Ytrain,'Method','regression','OOBPred','On','OOBVarImp','On','MinLeaf',minleaf);
toc;
...
figure();
barh(BaggedEnsemble.OOBPermutedVarDeltaError);
xlabel 'Feature' ;
...
Ybag = predict(BaggedEnsemble,college_hall_tree14.X);
...
Ybagt = predict(BaggedEnsemble,Xtest);
% RMSE
